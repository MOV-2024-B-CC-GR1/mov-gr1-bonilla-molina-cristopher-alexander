...
class ECrudEntrenador : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonEliminarBDD.setOnClickListener{
            ...
            if (respuesta) mostrarSnackbar("Ent. Elim") else mostrarSnackbar("No enocntrado")
        }
        ...
        botonCrearBDD.setOnClickListener{
            ...
            if (respuesta) mostrarSnackbar("Entr. Creado") else mostrarSnackbar("Falla al crear")
        }
        ...
        botonActualizarBDD.setOnClickListener{
            ...
            if (respuesta) mostrarSnackbar("Entr. Actualizada") else mostrarSnackbar("Falla al actualizar")
        }
    }
}
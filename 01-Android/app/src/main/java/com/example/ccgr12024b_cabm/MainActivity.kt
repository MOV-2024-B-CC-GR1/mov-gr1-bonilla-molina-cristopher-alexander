    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonExplicito
            .setOnClickListener{
                ...
                intentExplicito.putExtra("apellido", "Bonilla")
                intentExplicito.putExtra("Edad", 23)
                intentExplicito.putExtra("Entrenador",
                    BEntrenador(1, "Cristopher", "Ejemplo"))
                callbackContenidoIntentExplicito.launch(intentExplicito)
            }

        val botonIrSqlite = findViewById<Button>(R.id.btn_sqlite)
        botonIrSqlite.setOnClickListener{
            irActividad(ECrudEntrenador::class.java)
        }

        val botonIrFRecyclerView = findViewById<Button>(R.id.btn_recycler_view)
        botonIrFRecyclerView.setOnClickListener(){

                ...
                if (it.moveToFirst()) {
                    do {
                        val jugador = Jugador(
                            ...
                            fechaIngreso = dateFormat.parse(it.getString(it.getColumnIndexOrThrow("fechaIngreso"))) ?: Date(),
                            esTitular = it.getString(it.getColumnIndexOrThrow("esTitular")).toBoolean()
                        )
